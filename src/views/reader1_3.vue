                ...
                <transition type="transition" name="fade">
                  <div class="movie" v-if="sel === 1 && options === 0">
                    <iframe
                      ...
                      src="iframe/R1-3/R1-3Vocabulary/R1-3Vocabulary.html"
                      frameborder="0"
                    />
                  </div>
                </transition>
                ...
                <transition type="transition" name="fade">
                  <div v-if="sel === 3 && options === 0">
                    ...
                    <iframe
                      v-if="game_flow === 3"
                      style="width: 100%; height: 100%; position: absolute"
                      src="iframe/R1-3/R1-3Activity_1/R1-3Activity_1.html"
                      frameborder="0"
                    />
                  ...
                  <div v-if="sel === 3 && options === 1">
                    ...
                    <iframe
                      v-if="game_flow === 3"
                      style="width: 100%; height: 100%; position: absolute"
                      src="iframe/R1-3/R1-3Activity_2/R1-3Activity_2.html"
                      frameborder="0"
                    />
                    <div v-if="game_flow === 4">
                      <img src="images/settlement.jpg" alt="ima" />
