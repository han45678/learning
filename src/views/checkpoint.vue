<template>
  <transition type="transition" name="fade" enter-active-class="animated swing fade-enter-active"
    ...
    <div id="game_levels">
      ...
      <!-- 向左箭頭 -->
      <button v-if="this.order !== 1" id="left_arrow" @click="this.left_arrow"></button>
      ...
      <!-- 向右箭頭 -->
      <button v-if="this.order !== this.max_order" id="right_arrow" @click="this.right_arrow"></button>
