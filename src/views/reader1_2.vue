  ...
  >
    <div id="game_levels">
      ...
      >
        <main v-if="game">
          <div id="game">
            <div class="game_options" v-if="game_flow === 1 || game_flow === 2 || game_flow === 4">
            ...
            <div class="game_options" v-if="game_flow === 3 && sel==3">
            ...
            <div class="game_main">
              <div class="content">
                ...
                <transition type="transition" name="fade">
                  <div class="video" v-show="sel === 0 && options === 0">
                    <video controls>
                ...
                <!-- Vocabulary -->
                <transition type="transition" name="fade">
                  <div class="movie" v-if="sel === 1 && options === 0">
                    <iframe
                      style="width: 100%; height: 100%; position: absolute"
                      src="iframe/R1-2/R1-2Vocabulary/R1-2Vocabulary.html"
                      frameborder="0"
                    />
                  </div>
                </transition>
                <!-- 錄音 -->
                <transition type="transition" name="fade">
                  <div class="mic" v-if="sel === 2 && options === 0">
                    <iframe
                      style="
                        width: 100%;
                        height: 100%;
                ...
                <transition type="transition" name="fade">
                  <div v-if="sel === 3 && options === 0">
                    ...
                    <iframe
                      v-if="game_flow === 3"
                      style="width: 100%; height: 100%; position: absolute"
                      src="iframe/R1-2/R1-2Activity_1/R1-2Activity_1.html"
                      frameborder="0"
                    />
                  ...
                  <div v-if="sel === 3 && options === 1">
                    ...
                    <iframe
                      v-if="game_flow === 3"
                      style="width: 100%; height: 100%; position: absolute"
                      src="iframe/R1-2/R1-2Activity_2/R1-2Activity_2.html"
                      frameborder="0"
                    />
                    <div v-if="game_flow === 4">
                      <img src="images/settlement.jpg" alt="ima" />
  ...
  methods: {
    ...
    game_data() {
      ...
      this.$axios
        ...
        .get("json/game_reader1_" + sel + ".json")
