<template>
  <transition type="transition" name="fade" enter-active-class="animated swing fade-enter-active"
    ...
    <div id="game_levels">
      ...
      <!-- 向左箭頭 -->
      <router-link to="checkpoint" id="left_arrow" />

      <main>
        <div class="content">
          <router-link to="/" v-for="item in info.checkpoint" class="checkpoint"
