<template>
  <div id="game_levels">
    ...
    <!-- 向左箭頭 -->
    <router-link v-if="left_arrow !=''" :to="left_arrow" id="left_arrow" />
    ...
    <!-- 向右箭頭 -->
    <router-link v-if="right_arrow !=''" :to="right_arrow" id="right_arrow" />
    ...
    <!-- 遊戲鎖定 -->
    <div v-if="lock" id="lock" :class="{'unlock' : unlock}">
