    ...
    <main>
      <div class="content">
        <router-link to="/" v-for="item in checkpoint" class="checkpoint"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115.76 105.69" v-html="checkpoint_svg"></svg>
        </router-link>
      </div>
      <img src="../assets/images/level.svg" :alt="map">
    </main>
    <VueFooter />
  </div>
</template>
