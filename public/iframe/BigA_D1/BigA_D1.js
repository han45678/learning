...
lib.ssMetadata = [
		{name:"BigA_D1_atlas_", frames: [[0,0,1916,1108]]},
		{name:"BigA_D1_atlas_2", frames: [[0,0,1782,963]]},
		{name:"BigA_D1_atlas_3", frames: [[1742,0,70,1108],[0,0,1172,1108],[1174,0,566,1108],[1216,1110,425,163],[1643,1110,340,124],[1216,1275,425,163],[1814,163,226,124],[1814,559,123,119],[1814,680,123,119],[2019,289,21,56],[1987,289,30,85],[1945,289,40,67],[1814,426,123,131],[1814,289,129,135],[2044,0,2,16],[2028,0,14,14],[1814,0,212,161],[733,1110,481,414],[1643,1236,390,84],[1216,1440,465,129],[0,1110,731,539]]}
];
...
(lib.CachedBmp_25 = function() {
	this.initialize(ss["BigA_D1_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["BigA_D1_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ClipGroup = function(mode,startPosition,loop) {
	...
	mask.setTransform(468.9093,429.425);
...
(lib.ClipGroup_1 = function(mode,startPosition,loop) {
	...
	mask_1._off = true;
	mask_1.graphics.p("AvyLoIAA3PIflAAIAAXPg");
	mask_1.setTransform(101.35,74.9);

	// 圖層_3
	this.instance_3 = new lib.Image();
	this.instance_3.setTransform(0,0,0.2775,0.2779);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_1, new cjs.Rectangle(0.3,0.5,202.2,148.8), null);


(lib.drop_A0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.CachedBmp_22();
	this.instance.setTransform(-212.6,-81.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.drop_A0, new cjs.Rectangle(-212.6,-81.3,425,163), null);
...
(lib.Drag_A1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-169.85,-62);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// 圖層_1
	this.instance_1 = new lib.CachedBmp_21();
	this.instance_1.setTransform(-212.6,-81.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Drag_A1, new cjs.Rectangle(-212.6,-81.3,425,163), null);
...
(lib.Drag_A0 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-112.9,-62);
...
}).prototype = getMCSymbolPrototype(lib.Drag_A0, new cjs.Rectangle(-212.6,-81.3,425,163), null);
...
(lib.遊戲區 = function(mode,startPosition,loop) {
	...
	this.Drag_A1.setTransform(1162,295.55);

	this.Drag_A0 = new lib.Drag_A0();
	this.Drag_A0.name = "Drag_A0";
	this.Drag_A0.setTransform(1162,114.75);

	this.Drop_A0 = new lib.drop_A0();
	this.Drop_A0.name = "Drop_A0";
	this.Drop_A0.setTransform(230,431.85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.Drop_A0},{t:this.Drag_A0},{t:this.Drag_A1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.遊戲區, new cjs.Rectangle(17.4,33.5,1357,480.1), null);
...
(lib.BigA_D1 = function(mode,startPosition,loop) {
	...
	this.PlayNoPause_Ant.setTransform(755.95,364.45,0.8802,0.8802,0,0,0,0.3,0.1);

	this.timeline.addTween(cjs.Tween.get(this.PlayNoPause_Ant).wait(1));

	// GameDragDrop
	this.instance = new lib.CachedBmp_2();
	this.instance.setTransform(1384.1,368.45);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(1346.95,350.95);

	this.GameDragDrop = new lib.遊戲區();
	this.GameDragDrop.name = "GameDragDrop";
	this.GameDragDrop.setTransform(1116.8,781.4,1,1,0,0,0,696.1,305.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.GameDragDrop},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// 圖層_2
	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(1339.95,477.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// flash0_ai
	this.instance_3 = new lib.CachedBmp_10();
	this.instance_3.setTransform(1528.6,120.05);

	this.instance_4 = new lib.CachedBmp_9();
	this.instance_4.setTransform(1525.4,117.95);

	this.instance_5 = new lib.CachedBmp_8();
	this.instance_5.setTransform(1659.6,93.25);

	this.instance_6 = new lib.CachedBmp_8();
	this.instance_6.setTransform(1511.65,93.25);

	this.instance_7 = new lib.CachedBmp_6();
	this.instance_7.setTransform(1653.65,104.55);

	this.instance_8 = new lib.CachedBmp_6();
	this.instance_8.setTransform(1505.7,104.55);

	this.instance_9 = new lib.CachedBmp_4();
	this.instance_9.setTransform(1481.3,100.85);

	this.instance_10 = new lib.ClipGroup_1();
	this.instance_10.setTransform(583.25,452.25,4.8187,4.8187,0,0,0,101.5,75);
	...
	this.instance_11.setTransform(64.55,78.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1));

	// bg黃點
	this.instance_12 = new lib.ClipGroup();
	this.instance_12.setTransform(1916.9,1107.1,1.2904,1.2904,180,0,0,10.3,0.9);

	this.instance_13 = new lib.ClipGroup();
	this.instance_13.setTransform(-0.9,1.1,1.2904,1.2904,0,0,0,10.3,0.9);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BigA_D1_atlas_.png?1632272966938", id:"BigA_D1_atlas_"},
		{src:"images/BigA_D1_atlas_2.png?1632272966938", id:"BigA_D1_atlas_2"},
		{src:"images/BigA_D1_atlas_3.png?1632272966939", id:"BigA_D1_atlas_3"},
		{src:"sounds/Ant.mp3?1632272966964", id:"Ant"},
		{src:"sounds/RIGHT.mp3?1632272966964", id:"RIGHT"},
		{src:"sounds/WRONG.mp3?1632272966964", id:"WRONG"}
	],
	preloads: []
};
